    ...
    <div className="flex flex-col gap-5 p-5 md:p-7 max-w-7xl mx-auto w-full">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-200 pb-4 dark:border-zinc-800">
        ...
        <div className="flex items-center gap-2.5 flex-wrap">
          <button className="cursor-pointer flex h-8.5 items-center gap-1.5 rounded-lg border border-zinc-200 bg-white px-3 text-xs font-semibold text-zinc-700 shadow-xs hover:bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-300 dark:hover:bg-zinc-800 transition-colors">
          ...
          <button className="cursor-pointer flex h-8.5 w-8.5 items-center justify-center rounded-lg border border-zinc-200 bg-white text-zinc-600 shadow-xs hover:bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-400 dark:hover:bg-zinc-800 transition-colors">
      ...
      {children ? (
        ...
        <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-zinc-300 bg-zinc-50/50 p-10 text-center dark:border-zinc-800 dark:bg-zinc-900/30 min-h-[360px]">
          ...
          <button
            onClick={onActionClick}
            className="cursor-pointer flex h-7.5 items-center gap-1.5 rounded-md bg-amber-400 px-3.5 text-xs font-semibold text-black shadow-xs hover:bg-amber-500 transition-colors"
          >
